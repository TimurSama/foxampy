...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="relative min-h-screen lg:flex lg:items-center overflow-hidden">
      {/* Mobile: Photo full height bottom-left, text top-right */}
      <div className="lg:hidden relative h-screen">
        {/* Photo - Full height at bottom-left */}
        <motion.div 
          className="absolute left-0 bottom-0 h-[85vh] w-[55vw]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          {/* Real name */}
          <p className="text-xs font-mono text-white/40 tracking-[0.2em] uppercase mb-6 text-right">
            Timur Cadik
          </p>
